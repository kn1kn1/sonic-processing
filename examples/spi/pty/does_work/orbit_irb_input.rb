...
require 'psych'
CONFIG_FILE_PATH = '/Users/kanai/github/sonic-processing/rp5rc'
RP_CONFIG = (Psych.load_file(CONFIG_FILE_PATH))

load '/Users/kanai/github/sonic-processing/vendors/ruby-processing-2.6.17/lib/ruby-processing.rb'
load '/Users/kanai/github/sonic-processing/vendors/ruby-processing-2.6.17/lib/ruby-processing/app.rb'
